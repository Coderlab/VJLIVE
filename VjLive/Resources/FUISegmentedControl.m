...
+ (void)initialize {
    if (self == [FUISegmentedControl class]) {
        ...
        [appearance setDeselectedColor:[UIColor belizeHoleColor]];
        [appearance setDividerColor:[UIColor grayColor]];
        [appearance setSelectedFont:[UIFont flatFontOfSize:15.0]];
        [appearance setDeselectedFont:[UIFont flatFontOfSize:15.0]];
